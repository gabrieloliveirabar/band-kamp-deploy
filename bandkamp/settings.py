...
ALLOWED_HOSTS = ["deploy-entrega-production.up.railway.app","0.0.0.0"]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "BandKamp",
    "DESCRIPTION": " Music api created for the user to be able to create their albums and register the songs of the same. ",
